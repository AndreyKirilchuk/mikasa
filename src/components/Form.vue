...
<template>
  <div class="container">
    ...
    <form @submit.prevent="validateForm"  class="calculate_form">
      ...
      <h4 v-motion-slide-visible-once-left>Оставьте контакты и мы с вами<br> оперативно свяжемся</h4>
      <div class="sendForm">
        ...
        <div class="checkbox_inner" v-for="(checkbox, index) in checkboxes" :key="index" v-motion-slide-visible-once-bottom>
