  ...
  <div class="calculate" v-motion-fade-visible>
    ...
    <div class="calculate_header">
      <div class="progress_bar" v-if="progress < 6">
        <div
          v-for="step in 5"
          :key="step"
          :class="{ step: true, completed: step <= progress }"
        ></div>
      </div>
    </div>
    ...
    <form @submit.prevent="nextProgress" class="calculate_form" v-if="progress <= 4 ">
      ...
      <div class="options_img" v-if="progress === 1 || progress === 3" v-motion-fade-visible>
        <div
          v-for="(option, index) in questions[progress - 1].options"
          :key="index"
          class="option_img"
        >
      ...
      <div class="sendForm" v-motion-fade-visible>
        <div class="sendForm_input">
          ...
          <div class="error_text">
            <span v-if="error_name">*Обязательное поле для заполнения</span>
          </div>
        </div>
        ...
        <div class="sendForm_input">
          ...
          />
          <div class="error_text">
            <span v-if="error_number">*Обязательное поле для заполнения</span>
          </div>
        </div>
    ...
    <div class="accept_container" v-if="progress === 6">
        ...
        <h2 v-motion-fade-visible>
          Спасибо, данные успешно отправлены! Наш специалист скоро свяжется с вами!
        </h2>
