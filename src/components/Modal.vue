<script setup>
  ...
  const { closeModal } = inject('Reviews')
</script>

<template>
  <div class="fon" @click="closeModal" v-motion-fade-visible></div>

  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="cross" @click="closeModal"  v-motion-fade-visible>
  ...
  <iframe class="video" :src="ModalVideo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
